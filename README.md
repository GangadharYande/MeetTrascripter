...
1. Download the unpacked extension zip file from GitHub using this [link](https://github.com/GangadharYande/MeetTrascripter)
2. Open `chrome://extensions` in a new Chrome tab
3. Enable "Developer mode" from top right corner
4. Click on Load Unpacked
5. Select the file and Enjoy Transcripting CC's from meet !! 
